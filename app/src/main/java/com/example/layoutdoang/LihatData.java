...
public class LihatData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvnama = findViewById(R.id.tvNomorTelepon);
        ...
        switch (nama){
            ...
            case "Intan":
                ...
                tvnomor.setText("08122255334");
                break;
            case "Vina":
                tvnama.setText("Vina R");
                tvnomor.setText("08122553334");
                break;
            case "Gita":
